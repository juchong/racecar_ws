...
sudo apt-get -y install \
    ros-melodic-camera-info-manager ros-melodic-image-transport libbullet-dev libsdl-image1.2-dev ros-melodic-geometry2 ros-melodic-navigation ros-melodic-imu-filter-madgwick ros-melodic-roslint ros-melodic-joy ros-melodic-teleop-twist-joy ros-melodic-teleop-twist-keyboard ros-melodic-laser-proc ros-melodic-rgbd-launch ros-melodic-depthimage-to-laserscan ros-melodic-rosserial-arduino ros-melodic-rosserial-python ros-melodic-rosserial-server ros-melodic-rosserial-client ros-melodic-rosserial-msgs ros-melodic-amcl ros-melodic-map-server ros-melodic-move-base ros-melodic-urdf ros-melodic-xacro ros-melodic-compressed-image-transport ros-melodic-rqt-image-view ros-melodic-navigation ros-melodic-interactive-markers ros-melodic-ackermann-msgs ros-melodic-serial
