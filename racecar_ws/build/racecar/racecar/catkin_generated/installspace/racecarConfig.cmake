...
if("FALSE" STREQUAL "TRUE")
  set(racecar_SOURCE_PREFIX /home/niallmullane/racecar_ws/racecar_ws/src/racecar/racecar)
  set(racecar_DEVEL_PREFIX /home/niallmullane/racecar_ws/racecar_ws/devel)
  set(racecar_INSTALL_PREFIX "")
  set(racecar_PREFIX ${racecar_DEVEL_PREFIX})
else()
  set(racecar_SOURCE_PREFIX "")
  set(racecar_DEVEL_PREFIX "")
  set(racecar_INSTALL_PREFIX /home/niallmullane/racecar_ws/racecar_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'racecar' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/niallmullane/racecar_ws/racecar_ws/install/${idir}'.  ${_report}")
    endif()
...
set(depends "tf;tf2_ros;urg_node;joy;joy_teleop;laser_scan_matcher;rosbag;rostopic;rviz;gmapping;hector_mapping;robot_pose_ekf")
