...
{
//AckermannDriveStamped::ackermann_cmd_input_callback(ros::NodeHandle nh,ros::NodeHandle private_nh)
...
//ackermann_sub_ = nh.subscribe("joy_teleop",&AckermannToVesc::ackermannCmdCallback, this);
